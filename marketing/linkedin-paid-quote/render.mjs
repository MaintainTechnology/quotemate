// Render paid-quote.html to one PNG per graphic.
//
...
if (wantPdf) {
  ...
  await page.pdf({ path: join(OUT, 'quotemax-paid-quote.pdf'), width: `${W}px`, height: `${H}px`, printBackground: true })
  console.log('  ok quotemax-paid-quote.pdf')
}
