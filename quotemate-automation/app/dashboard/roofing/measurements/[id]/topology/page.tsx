  ...
  return (
    <main className="min-h-screen bg-ink-deep text-text-pri">
      <section className="mx-auto max-w-7xl px-6 py-14 sm:px-10 md:py-20">
        <nav className="flex flex-wrap items-center gap-3 font-mono text-[0.72rem] font-semibold uppercase tracking-[0.16em] text-text-dim" aria-label="Breadcrumb">
        ...
        {state.status === 'ready' && (
          <>
            <div className="mt-9 grid gap-8 border-b border-ink-line pb-9 lg:grid-cols-[minmax(0,1fr)_18rem] lg:items-end">
              <div>
                <div className="font-mono text-[0.75rem] font-semibold uppercase tracking-[0.18em] text-accent">Saved roofing measurement</div>
...
function LoadingState() {
  return (
    <div className="mt-10 border border-ink-line bg-ink-card p-8" role="status">
      <div className="flex items-center gap-3 font-mono text-[0.75rem] font-semibold uppercase tracking-[0.16em] text-accent">
...
function ErrorState({ message }: { message: string }) {
  return (
    <div className="mt-10 border border-ink-line border-l-4 border-l-warning bg-ink-card p-7">
      <div className="font-mono text-[0.75rem] font-semibold uppercase tracking-[0.16em] text-warning">Topology evidence unavailable</div>
