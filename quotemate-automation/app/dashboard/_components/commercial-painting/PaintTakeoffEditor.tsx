    ...
    <div className="mt-5">
      ...
      {flags.length > 0 && (
        <div className="rounded-card border border-ink-line bg-ink-deep">
          ...
          >
            <span className="font-mono text-micro font-semibold uppercase tracking-[0.14em] text-warning">
      ...
      {finishesSchedule.length > 0 && (
        <details className="rounded-card mt-3 border border-ink-line bg-ink-deep">
          <summary className="cursor-pointer list-none px-4 py-2.5 font-mono text-micro font-semibold uppercase tracking-[0.14em] text-text-dim transition-colors hover:text-text-sec [&::-webkit-details-marker]:hidden">
      ...
      <div className="rounded-card mt-4 flex flex-wrap items-center gap-3 border border-ink-line bg-ink-deep px-4 py-3">
        ...
        <button
          ...
          className="rounded-ctl inline-flex cursor-pointer items-center gap-1.5 border border-ink-line bg-ink-card px-3 py-1.5 font-mono text-micro font-semibold uppercase tracking-[0.12em] text-text-sec transition-colors hover:border-accent hover:text-accent disabled:cursor-not-allowed disabled:opacity-40"
        >
          Apply to all lines
        </button>
        <span className="font-mono text-micro uppercase tracking-[0.1em] text-text-dim">
          ...
          <div key={room}>
            <div className="flex items-center gap-3">
              ...
              <button
                type="button"
                onClick={() => addRow(room)}
                className="inline-flex cursor-pointer items-center gap-1 font-mono text-micro font-semibold uppercase tracking-[0.12em] text-text-dim transition-colors hover:text-accent"
              >
            ...
            <div className="mt-2 overflow-x-auto">
              <table className="w-full min-w-[760px] border-collapse text-sm">
                <thead>
                  <tr className="text-left font-mono text-micro uppercase tracking-[0.12em] text-text-dim">
      ...
      <div className="mt-5 flex flex-wrap items-center gap-4 border-t border-ink-line pt-4">
        <label className="flex items-center gap-2 font-mono text-micro font-semibold uppercase tracking-[0.12em] text-text-dim">
          Labour rate $/hr
          <input
            type="number"
            step="1"
        ...
        <button
          ...
          className="inline-flex cursor-pointer items-center gap-1.5 font-mono text-micro font-semibold uppercase tracking-[0.14em] text-text-dim transition-colors hover:text-text-sec"
        >
