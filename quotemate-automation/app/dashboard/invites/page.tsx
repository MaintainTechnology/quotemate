    ...
    <main className="relative min-h-screen overflow-hidden bg-ink-deep text-text-pri">
      ...
      <div aria-hidden className="pointer-events-none absolute inset-0">
        ...
        <div className="absolute inset-0 opacity-[0.04]"
             style={{ backgroundImage: 'linear-gradient(var(--ink-line) 1px, transparent 1px), linear-gradient(90deg, var(--ink-line) 1px, transparent 1px)', backgroundSize: '64px 64px' }} />
      </div>
