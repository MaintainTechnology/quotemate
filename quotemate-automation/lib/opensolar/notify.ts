// OpenSolar proposal → customer SMS body (sent on tradie-confirm when the
// project carried a customer mobile). PURE — mirrors buildPylonCustomerSms.

export function buildOpenSolarCustomerSms(args: {
  businessName: string
